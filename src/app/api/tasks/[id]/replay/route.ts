...
const replaySchema = z.object({
  ...
  injectedAnalysis: z.record(z.string(), z.unknown()).optional(),
  injectedPlans: z.array(z.record(z.string(), z.unknown())).optional(),
  injectedVariables: z.record(z.string(), z.unknown()).optional(),
})
