  ...
  return (
    <SafeAreaView className="flex-1 bg-white justify-center px-6">
      <View className="items-center mb-8">
        <Text className="text-3xl font-bold text-indigo-600">Créer un compte</Text>
        <Text className="text-gray-400 mt-2">Rejoins Genova</Text>
      </View>
      ...
      <TouchableOpacity onPress={() => navigation.goBack()} className="items-center">
        <Text className="text-indigo-600">Déjà un compte ? Se connecter</Text>
      </TouchableOpacity>
    </SafeAreaView>
  );
}
